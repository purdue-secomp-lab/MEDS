...
set(ALL_MEDS_SUPPORTED_ARCH ${X86_64})
...
if(APPLE)
  ...
  list_intersect(MEDS_SUPPORTED_ARCH
    ALL_MEDS_SUPPORTED_ARCH
    SANITIZER_COMMON_SUPPORTED_ARCH)
  ...
  filter_available_targets(MEDS_SUPPORTED_ARCH ${ALL_MEDS_SUPPORTED_ARCH})
...
set(ALL_SANITIZERS asan;meds;dfsan;msan;tsan;safestack;cfi;esan;scudo)
...
if (COMPILER_RT_HAS_SANITIZER_COMMON AND MEDS_SUPPORTED_ARCH
    AND OS_NAME MATCHES "Linux")
  set(COMPILER_RT_HAS_MEDS TRUE)
else()
  set(COMPILER_RT_HAS_MEDS FALSE)
endif()
