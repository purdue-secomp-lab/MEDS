...
// RUN: %clangxx_meds -O0 %s -o %t && %run %t | FileCheck %s
// RUN: %clangxx_meds -O1 %s -o %t && %run %t | FileCheck %s
// RUN: %clangxx_meds -O2 %s -o %t && %run %t | FileCheck %s
// RUN: %clangxx_meds -O3 %s -o %t && %run %t | FileCheck %s
