...
// try the second flag).
//
// RUN: %clangxx_meds -c %s -o %t.o
// RUN: %clangxx_meds -DBUILD_SO=1 -fPIC -shared %s -o %t.so -Wl,-Ttext-segment=0x3600000000 ||\
// RUN: %clangxx_meds -DBUILD_SO=1 -fPIC -shared %s -o %t.so -Wl,-Ttext=0x3600000000
// RUN: %clangxx_meds %t.o %t.so -Wl,-R. -o %t
