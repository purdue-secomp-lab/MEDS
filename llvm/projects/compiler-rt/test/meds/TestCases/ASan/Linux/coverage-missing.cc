...
// RUN: %clangxx_meds -fsanitize-coverage=func %s -o %t -DFOOBAR -DMAIN
...
// cd %T
// RUN: %clangxx_meds -fsanitize-coverage=func %s -o %dynamiclib -DFOOBAR -shared -fPIC
// RUN: %clangxx_meds -fsanitize-coverage=func %s %dynamiclib -o %t -DMAIN
