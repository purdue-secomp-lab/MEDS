...
// RUN: %clangxx_meds -O0 %s %p/Helpers/initialization-nobug-extra.cc -o %t
// RUN: %env_asan_opts=check_initialization_order=true %run %t 2>&1
// RUN: %clangxx_meds -O1 %s %p/Helpers/initialization-nobug-extra.cc -o %t
// RUN: %env_asan_opts=check_initialization_order=true %run %t 2>&1
// RUN: %clangxx_meds -O2 %s %p/Helpers/initialization-nobug-extra.cc -o %t
// RUN: %env_asan_opts=check_initialization_order=true %run %t 2>&1
// RUN: %clangxx_meds -O3 %s %p/Helpers/initialization-nobug-extra.cc -o %t
// RUN: %env_asan_opts=check_initialization_order=true %run %t 2>&1
