...
// RUN: %clangxx_meds -fsanitize-blacklist=%tmp -O0 %s -o %t \
// RUN: %p/Helpers/blacklist-extra.cc && %run %t 2>&1
// RUN: %clangxx_meds -fsanitize-blacklist=%tmp -O1 %s -o %t \
// RUN: %p/Helpers/blacklist-extra.cc && %run %t 2>&1
// RUN: %clangxx_meds -fsanitize-blacklist=%tmp -O2 %s -o %t \
// RUN: %p/Helpers/blacklist-extra.cc && %run %t 2>&1
// RUN: %clangxx_meds -fsanitize-blacklist=%tmp -O3 %s -o %t \
// RUN: %p/Helpers/blacklist-extra.cc && %run %t 2>&1
