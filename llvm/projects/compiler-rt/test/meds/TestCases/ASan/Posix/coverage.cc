// RUN: %clangxx_meds -fsanitize-coverage=func -DSHARED %s -shared -o %dynamiclib -fPIC %ld_flags_rpath_so
// RUN: %clangxx_meds -fsanitize-coverage=func %s %ld_flags_rpath_exe -o %t
