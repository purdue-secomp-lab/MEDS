...
// modules.
// RUN: %clangxx_meds -fsanitize-coverage=func -DSHARED %s -shared -o %dynamiclib1 -fPIC
// RUN: %clangxx_meds -fsanitize-coverage=func -DSHARED %s -shared -o %dynamiclib2 -fPIC
