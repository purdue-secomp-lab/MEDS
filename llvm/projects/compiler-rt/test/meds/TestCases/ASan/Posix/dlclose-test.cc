...
// RUN: %clangxx_meds -O0 %s %libdl -o %t && %run %t 2>&1 | FileCheck %s
// RUN: %clangxx_meds -O1 -DSHARED_LIB %s -fPIC -shared -o %t-so.so
// RUN: %clangxx_meds -O1 %s %libdl -o %t && %run %t 2>&1 | FileCheck %s
// RUN: %clangxx_meds -O2 -DSHARED_LIB %s -fPIC -shared -o %t-so.so
// RUN: %clangxx_meds -O2 %s %libdl -o %t && %run %t 2>&1 | FileCheck %s
// RUN: %clangxx_meds -O3 -DSHARED_LIB %s -fPIC -shared -o %t-so.so
// RUN: %clangxx_meds -O3 %s %libdl -o %t && %run %t 2>&1 | FileCheck %s
