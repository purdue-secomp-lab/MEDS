// RUN: %clangxx_meds -fsanitize-coverage=bb -DSHARED %s -shared -o %dynamiclib -fPIC %ld_flags_rpath_so
// RUN: %clangxx_meds -fsanitize-coverage=func %s -o %t %ld_flags_rpath_exe
