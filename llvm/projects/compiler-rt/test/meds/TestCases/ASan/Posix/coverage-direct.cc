...
// RUN: %clangxx_meds -fsanitize-coverage=func -DSHARED %s -shared -o %dynamiclib -fPIC
// RUN: %clangxx_meds -fsanitize-coverage=func %s %libdl -o %t
...
// RUN: %clangxx_meds -fsanitize-coverage=bb -DSHARED %s -shared -o %dynamiclib -fPIC
// RUN: %clangxx_meds -fsanitize-coverage=bb -DSO_DIR=\"%T\" %s %libdl -o %t
...
// RUN: %clangxx_meds -fsanitize-coverage=edge -DSHARED %s -shared -o %dynamiclib -fPIC
// RUN: %clangxx_meds -fsanitize-coverage=edge -DSO_DIR=\"%T\" %s %libdl -o %t
