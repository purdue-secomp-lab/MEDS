...
// RUN: %clang_meds -c -o %t-one.o -DMAIN_FILE %s
// RUN: %clang_meds -c -o %t-two.o -DSECONDARY_FILE %s
// RUN: %clang_meds -o %t %t-one.o %t-two.o %libdl
// RUN: %clang_meds -o %t-dynamic.so -shared -fPIC -DSHARED_LIBRARY_FILE %s
